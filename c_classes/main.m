...
#include "Python.h"
#include "/Users/aboba/Documents/ios-build/dist/include/common/sdl2/SDL_main.h"
#include <dlfcn.h>
#include "/Users/aboba/Documents/ios-build/build/sdl2/arm64/SDL2-2.24.1/src/video/uikit/SDL_uikitappdelegate.h"
...
@interface myDelegate: SDLUIKitDelegate <UIApplicationDelegate, UNUserNotificationCenterDelegate>
@end

@implementation myDelegate
- (void)userNotificationCenter:(UNUserNotificationCenter *)center willPresentNotification:(UNNotification *)notification withCompletionHandler:(void (^)(UNNotificationPresentationOptions))completionHandler{
    UNNotificationPresentationOptions presentOptions = UNNotificationPresentationOptionAlert +UNNotificationPresentationOptionSound;
...
// this method call only if application is currentlyy in background mode
// background session does not send any events until this method return 
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary<UIApplicationLaunchOptionsKey,id> *)launchOptions{
    ...
    NSLog(@"Overrided successfully");
    return ret;
}

@end

// overriding application delegate
